...
pub const stateless_retrieval_result =
    core.stateless_retrieval_result;
...
pub const StatelessRetrievalResult =
    core.StatelessRetrievalResult;
...
pub const DenseTensorRetrieval =
    core.DenseTensorRetrieval;
