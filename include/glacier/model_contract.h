...
#define GLACIER_MODEL_SUPPORT_PROFILE_COUNT_V1 UINT64_C(12)
...
#define GLACIER_MODEL_FAMILY_TOOL_EXECUTOR UINT64_C(18)
...
#define GLACIER_MODEL_OPERATION_GENERATE_SEQUENCE UINT64_C(13)
#define GLACIER_MODEL_OPERATION_EXECUTE_ACTION UINT64_C(14)
#define GLACIER_MODEL_OPERATION_RETRIEVE UINT64_C(15)
...
#define GLACIER_MODEL_INPUT_EMBEDDING_I32 UINT64_C(8)
...
#define GLACIER_MODEL_OUTPUT_TOOL_RESULT UINT64_C(12)
#define GLACIER_MODEL_OUTPUT_RETRIEVAL_HITS UINT64_C(13)
...
#define GLACIER_MODEL_SUPPORT_PROFILE_DENSE_TENSOR_RERANKER \
    UINT64_C(0x4744525200000001)
#define GLACIER_MODEL_SUPPORT_PROFILE_DENSE_TENSOR_EMBEDDING \
    UINT64_C(0x4744454d00000001)
#define GLACIER_MODEL_SUPPORT_PROFILE_DENSE_TENSOR_CLASSIFIER \
    UINT64_C(0x4744434c00000001)
#define GLACIER_MODEL_SUPPORT_PROFILE_DENSE_TENSOR_RETRIEVAL \
    UINT64_C(0x4744525400000001)
...
#define GLACIER_MODEL_SUPPORT_INDEX_DENSE_TENSOR_RERANKER UINT64_C(8)
#define GLACIER_MODEL_SUPPORT_INDEX_DENSE_TENSOR_EMBEDDING UINT64_C(9)
#define GLACIER_MODEL_SUPPORT_INDEX_DENSE_TENSOR_CLASSIFIER UINT64_C(10)
#define GLACIER_MODEL_SUPPORT_INDEX_DENSE_TENSOR_RETRIEVAL UINT64_C(11)
...
#define GLACIER_MODEL_SUPPORT_MASK_DENSE_TENSOR_RERANKER \
    (UINT64_C(1) << GLACIER_MODEL_SUPPORT_INDEX_DENSE_TENSOR_RERANKER)
#define GLACIER_MODEL_SUPPORT_MASK_DENSE_TENSOR_EMBEDDING \
    (UINT64_C(1) << GLACIER_MODEL_SUPPORT_INDEX_DENSE_TENSOR_EMBEDDING)
#define GLACIER_MODEL_SUPPORT_MASK_DENSE_TENSOR_CLASSIFIER \
    (UINT64_C(1) << GLACIER_MODEL_SUPPORT_INDEX_DENSE_TENSOR_CLASSIFIER)
#define GLACIER_MODEL_SUPPORT_MASK_DENSE_TENSOR_RETRIEVAL \
    (UINT64_C(1) << GLACIER_MODEL_SUPPORT_INDEX_DENSE_TENSOR_RETRIEVAL)
