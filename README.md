...
- **Portable reports with a production-native Metal producer.** The W6a
...
Add `-Dnative-metal-report-output=PATH` to the focused report gate, or
...
verification. The two retention options are mutually exclusive in one build
invocation.
