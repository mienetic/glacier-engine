...
uses the sink-free direct-terminal generation-one-to-two path. Its retained
real-process-death campaign and a public package producer for an ordinary
user-supplied model remain open.
