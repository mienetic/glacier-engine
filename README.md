...
- **Bounded loopback HTTP/1.1.** An experimental serial socket adapter exposes
  ...
  error correlation without redirects or automatic retries. Non-loopback
  serving, authentication, TLS, streaming, restart, disconnect, and
...
The Phase B held-open partial-header and partial-body drain cases reuse that
