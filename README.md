...
additive direct-terminal path needed for fixed output count one remains open.
There is not yet a public package producer for an ordinary user-supplied model.
