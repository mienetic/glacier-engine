...
work next adds exact post-parse service-capacity and Scheduler-rejection
...
- [ ] Add exact cause-specific post-parse application-rejection observability
  for service-capacity and Scheduler rejection through the existing unary HTTP
  and managed-process roots, without adding an artifact or compile root.
