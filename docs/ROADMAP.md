...
4. keyframe selection, exact frame/time mappings, temporal-cache ownership, and
   ...
   coalesce same-event overlap while retaining gaps and event changes;
   audio/subtitle linkage and stateful video-model restart remain;
