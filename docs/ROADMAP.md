...
4. keyframe selection, exact frame/time mappings, temporal-cache ownership, and
   ...
   event/confidence fields; audio/subtitle linkage, segment merge policy, and
   stateful video-model restart remain;
