...
13. ~~Expose the retained filesystem composition through public Zig entry
    ...
    progress. Its process-death campaign, the package producer, CLI/serving
    integration, and non-POSIX native evidence remain open.
