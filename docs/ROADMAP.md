...
- [ ] Finish replacing direct durable-file calls with bounded recovery
  adapters. Production runtime-image preparation now uses an acquired POSIX
  publisher with a bounded candidate and exact recovery; model conversion,
