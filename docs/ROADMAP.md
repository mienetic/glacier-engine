...
- [ ] Add a runtime-capacity `1..64` driver and ordinary-model package producer,
  then integrate the checked committed-output view into `text-run` without
...
13. ~~Expose the retained filesystem composition through public Zig entry
    ...
    points. A runtime-capacity `1..64` driver, package producer, CLI/serving
