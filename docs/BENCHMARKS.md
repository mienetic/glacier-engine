...
manual native-load target now supplies one fixed successful CPU profile.
Broader overload/rejection, production-model, repeated, GPU, and
publication-eligible native Linux campaigns remain pending.
