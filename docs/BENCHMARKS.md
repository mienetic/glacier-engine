...
producer, and the finite W7a controlled-disruption campaign are integrated.
...
full-slot outcomes; it is not a physical-fault or duration-soak campaign.
Broader retained machine matrices, direct physical telemetry,
duration-bounded soak, and reproducible physical/process disruption remain
staged. The sequence is defined in the
